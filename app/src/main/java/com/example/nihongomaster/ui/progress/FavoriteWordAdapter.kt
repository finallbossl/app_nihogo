...
class FavoriteWordAdapter : ListAdapter<FavoriteWord, FavoriteWordAdapter.ViewHolder>(Diff) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(ItemFavoriteWordBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
    ...
    class ViewHolder(private val binding: ItemFavoriteWordBinding) : RecyclerView.ViewHolder(binding.root) {
